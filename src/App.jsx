              ...
              <User>
                <OrderState>
                  ...
                  <Routes>
                    ...
                    <Route path="/admin/company-profit" element={admin ? <CompanyProfit /> : nouser ? <Navigate to='/admin/login' /> : null} />

                    <Route path="/admin/dropship-profit-report" element={admin ? <DropshipProfitReport /> : nouser ? <Navigate to='/admin/login' /> : null} />
                    ...
                    <Route path="/admin/about" element={admin ? <AboutPage /> : nouser ? <Navigate to='/admin/login' /> : null} />
