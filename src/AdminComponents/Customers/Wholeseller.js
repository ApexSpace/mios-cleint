  ...
  const signedUp = async (e) => {
    ...
    try {
      if (
        ...
        Notification(
          "Success",
          "WholeSeller User Created Successfully",
          "success"
        );
      }
    } catch (e) {
          ...
          {show ? (
            <div>
              <div className="row mb-3">
                ...
                <h1 className="col">
                  All WholeSellers Accounts({filterUsers && filterUsers.length})
                </h1>
                <div className="col text-end me-5">
                  ...
                  >
                    {show ? `Add New WholeSeller` : `Show All Wholesellers`}
                  </button>
                </div>
              </div>
              <br />
            ...
            <section className="mt-0" style={{ marginTop: "2%" }}>
              ...
              <div className="login ">
                <form method="post">
                  <label className="text-start mb-0 mt-3">name</label>
                  <input
                    value={name}
                    type="name"
                    name="name"
                    ...
                    required
                  />
                  <label className="text-start mb-0 mt-3">email</label>
                  <input
                    value={email}
                    type="email"
                    name="email"
                    ...
                    required
                  />
                  <label className="text-start mb-0 mt-3">password</label>
                  <input
                    value={password}
                    className="mb-3"
                    type="password"
                    ...
                    required
                  />
                  <label className="text-start mb-0 mt-3">Phone number</label>
                  <input
                    value={phone}
                    type="phone"
                    name="phone"
                  ...
                  />
                  <br />
                  <label className="text-start mb-0 mt-3">City</label>
                  <select
                    name="city"
